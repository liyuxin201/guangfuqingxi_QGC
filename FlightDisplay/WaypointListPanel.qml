                ...
                Row {
                    ...
                    IconButton {
                        ...
                        onClicked: {
                            ...
                            for(var i =0 ; i < Shared.AppState.clearModes.length - waypointListView.currentIndex -1;  i++)
                            {
                            Shared.AppState.clearModes[waypointListView.currentIndex + i] = Shared.AppState.clearModes[waypointListView.currentIndex + 1 + i];
